      ...
      body: GetX<AppDataController>(
        ...
        return controller.cardList.isEmpty ? Container(
          ...
          child: Column(
            ...
            children: [
              const FaIcon(FontAwesomeIcons.creditCard,color: MyColor.iconColor,size: 60,),
          ...
          itemBuilder: (context, index) {
            ...
            return Dismissible(
              ...
              background: Container(alignment:Alignment.centerRight,color: Colors.red,child: const Padding(padding: EdgeInsets.symmetric(horizontal: 16),
                child: Icon(Icons.delete,color: Colors.white,),
              ),),
              key: UniqueKey(),
              child: ListTile(
                leading: const FaIcon(FontAwesomeIcons.creditCard,size: 35,color: MyColor.buttonColor,),
                title: Text(model.name),
                subtitle: Text(model.cardNo??""),
              ),
            );
        },);
      },)
